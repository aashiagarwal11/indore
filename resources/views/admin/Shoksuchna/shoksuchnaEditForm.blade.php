                    ...
                    <div class="col-12 col-sm-6 col-md-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                <a href="{{ route('shoksuchnaList') }}" class="btn btn-danger m-1">View List</a>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="card card-primary">
                                        <div class="card-header">
                                            <h3 class="card-title">Edit Shok Suchna <small>Form</small></h3>
                                        </div>
                                        <!-- form start -->
                                        <form id="quickForm" class="was-validated" action="{{ route('updateshoksuchna') }}"
                                            method="POST">
                                            @method('PUT')
                                            @csrf
